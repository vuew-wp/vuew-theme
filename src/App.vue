<template>
    <main :class="[ bodyClass, isLoaded ? 'vw-component-loaded' : 'vw-component-pending' ]">
        ...
        <div class="vw-site-container">
            ...
            <above-the-fold v-if="query.isArchive && isFirstLoad" :query="query"></above-the-fold>

            <transition name="vw-fade-transition">
                <above-the-fold v-if="query.isArchive && !isFirstLoad && !pending" :query="query"></above-the-fold>
            </transition>

            <transition name="vw-fade-transition">
                <vw-template v-if="!pending" :query="query" class="uk-position-relative"></vw-template>
            </transition>
