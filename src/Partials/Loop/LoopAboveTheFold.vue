<template>
    <div>
        ...
        <div class="uk-overflow-auto" style="white-space: nowrap">
            <div v-for="post in queryData" :key="post.path" class="uk-display-inline-block" style="display: inline-block; width: 90vw;">
                <router-link :to="setMenuItemParams( post )">
                    <attachment :src="post.featured_media.thumbnail" :type="'background'" style="padding-bottom: 100%; background-color: #444;" class="uk-width-1-1 uk-position-relative">
