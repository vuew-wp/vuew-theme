<template>
    <article
            :class="[ 'uk-width-1-' + columns + '@m', displayExcerpt ? 'post-vuew-content-open' : 'post-vuew-content-closed']"
        ...
        <div class="uk-position-relative uk-float-left uk-width-1-1">
            <attachment :src="post.featured_media.thumbnail" :type="'background'"
                        class="post-vuew-image uk-position-cover"></attachment>
            <div class="post-vuew-title uk-position-bottom">
                ...
                <a @click="toggleExcerpt" class="post-vuew-excerpt-toggle uk-margin-top uk-position-bottom-center"
                   v-html="require( '../../svg/arrow-down.svg' )"></a>
            </div>
            <span v-text="post.date"
                  class="post-vuew-date uk-position-top-left uk-background-primary uk-text-small"></span>
        </div>
