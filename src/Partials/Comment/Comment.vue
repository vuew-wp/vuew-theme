<template>
  <div
    ...
    class="comment vw-comment vw-block"
  >
    <!--Comment-->
    <div class="uk-margin-bottom uk-width-1-1">
      <attachment
        :src="commentData.comment_author_avatar"
        :type="'standard'"
      ...
      <a
        ...
        v-text="displayForm ? 'X Close' : 'Reply'"
      ></a>
      ...
      <div v-show="displayForm" class="comment-reply">
        ...
        />
        <div v-show="commentPending" v-text="'Loading'"></div>
      </div>
