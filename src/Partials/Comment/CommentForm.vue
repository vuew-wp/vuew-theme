<template>
    <div>
        ...
        <div class="vw-comment-form" v-if="canDisplay && '' === formState">
            <vw-form :form-data="$options.commentFormData" v-on:process-form="processComment"></vw-form>
        </div>
        <div v-else-if="'registrationRequired' === formState">
            <off-canvas-toggle target="userOffCanvas">registrationRequired</off-canvas-toggle>
        </div>
