<template>
  <div class="uk-position-relative">
    <div v-if="inView">
      <div
        v-if="!getSource && four04"
        v-html="require('../svg/image-404.svg')"
      ...
      <div
        v-else-if="getSource && loaded && type === 'background'"
        class="uk-background-cover uk-position-cover"
      ...
      <img
        v-else-if="getSource && loaded && type === 'standard'"
        :src="getSource"
      />

      <div
        v-else-if="!getSource && useInternalFallback"
        class="uk-background-cover uk-position-cover"
      >
        <div
          class="uk-background-cover uk-position-cover uk-overflow-hidden"
          v-html="require('../svg/vuew-logo.svg')"
        ></div>
        <slot></slot>
      </div>
...
export default {
  ...
  mounted: function() {
    ...
    const routeTransitionDelay = vm.$store.getters['isFirstLoad']
      ? 0
