<template>
    <div>
        ...
        <div v-if="isPending" v-for="i in ppp" :class="'uk-width-large-1' + columns" class="uk-margin-bottom">
            <div class="vw-flicker-loading-post" :style="{ animationDelay : getRandomDelay() + 's' }">
            </div>
        </div>
