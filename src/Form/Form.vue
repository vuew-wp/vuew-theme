<template>
    <div class="uk-padding-large">
        ...
        <p v-html="status"></p>
        <form @submit.prevent="handleSubmit" novalidate="novalidate" class="uk-grid uk-form-stacked">
            ...
            <div v-for="field in formData.properties" :key="field.id" class="uk-width-1-1">
                ...
                <form-field-text-area v-else-if="'textarea' === field.type" :field="field"
                                      v-on:input="handleChange"/>
  ...
  export default {
    ...
    methods: {
      ...
      handleChange(payload) {
        ...
        if (Object.prototype.hasOwnProperty.call(this.requiredFields, payload.id)) {
      ...
      submit(params) {
        ...
        HTTP_Vuew.post(this.endPoint, params, {
          ...
          this.$store.dispatch('user/updateUserId', response.data.message.userId);
