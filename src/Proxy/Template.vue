...
export default {
  components: {
    taxonomy: () => ({
      component: import(
        /* webpackChunkName: "archive" */ '../Archive/Taxonomy.vue'
      ),
      ...LoadingErrorComponents,
    }),
    post_type_archive: () => ({
      component: import(
        /* webpackChunkName: "archive" */ '../Archive/PostType.vue'
      ),
      ...LoadingErrorComponents,
    }),
    single: () => ({
      component: import(
        /* webpackChunkName: "single" */ '../Single/Single.vue'
      ),
      ...LoadingErrorComponents,
    }),
    home: () => ({
      component:
        parseInt(Vuew.config.pageOnFront) > 0
